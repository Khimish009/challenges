...
## 🎯 Philosophy
*   **Speed:** Rapid prototyping to understand core concepts.
*   **Practice:** "Hands-on" approach over passive reading.
*   **Modernity:** focus on cutting-edge stacks (Next.js App Router, React Server Components, TanStack Query, etc.).
