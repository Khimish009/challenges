...
Пользователь отправляет текст, фоновый воркер генерирует PDF (с искусственной задержкой 15 сек для симуляции тяжёлой задачи), фронтенд поллит статус до готовности файла.
